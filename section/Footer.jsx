        ...
        <Box>
            ...
            <div className='pt-10'>
                ...
                <div className="flex justify-center mt-2">
                    <a href="https://www.instagram.com/dpmfilkomub/" target={'_blank'} className="hover:scale-105">
                        <img src="/assets/icons/ig.svg" className='mx-2'/>
                    </a>
                    <a href="https://www.youtube.com/channel/UCgTkPWmWzN_RAvTgg1lDdIQ" target={'_blank'} className="hover:scale-105">
                        <img src="/assets/icons/yt.svg" className='mx-2'/>
                    </a>
                    <a href="https://twitter.com/dpmfilkomub" target={'_blank'} className="hover:scale-105">
                        <img src="/assets/icons/tw.svg" className='mx-2'/>
                    </a>
                    <a href="https://www.linkedin.com/company/dpm-filkom-ub/about/" target={'_blank'} className="hover:scale-105">
